...
model_dir = '/content/drive/MyDrive/MFNet-pytorch-master/weights/pool_mffenet/'
...
def main():
    ...
    train_dataset = MF_dataset_new(data_dir, cropsize=cropsize, mode='train', randomscale=randomscale)
    val_dataset = MF_dataset_new(data_dir, mode='test', randomscale=randomscale)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name',  '-M',  type=str, default='pool_mffenet')
