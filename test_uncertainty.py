...
from model import FuseSeguseuncertainty,mffenetusetrans_c,FuseSeguseboundary,mffenetusecswintrans,fusesegusetrans_new,fusesegusetrans5,fusesegusetrans2,MFNet,RTFNet,afnet,FuseSeg,FuNNet,afnetusetrans,fusesegusetrans,fusesegusetrans3,fusesegusetrans4
from train_uncertainty import n_class, data_dir, model_dir
