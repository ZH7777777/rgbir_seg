...
from model import fusesegusetrans2,MFNet,RTFNet,afnet,FuseSeg,FuNNet,afnetusetrans,fusesegusetrans,fusesegusetrans3,fusesegusetrans4
from trainwithlightnet import n_class, data_dir, model_dir
...
def main():
    ...
    with torch.no_grad():
        for it, (images, labels, names) in enumerate(test_loader):
            ...
            visualize3(it,enhanced_images_rgb,rgb,names)
            visualize4(it,enhanced_images_ir,ir,names)
