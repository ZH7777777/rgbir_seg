...
class fusesegusetrans5(nn.Module):
    def __init__(self, n_class):
        super(fusesegusetrans5, self).__init__()
    ...
    def forward(self, x):
        ...
        image2 = torch.cat([image2, batch_external_seq1], dim=1)   # 1*1114*70
        thermal2 = torch.cat([thermal2, batch_external_seq2], dim=1)
        # ---------------------------------------------
        ...
        thermal2 = self.position_encoding2(thermal2)  # 1*1114*70
        ...
        thermal2 = self.pre_head_ln2(thermal2)#1*1112*70
