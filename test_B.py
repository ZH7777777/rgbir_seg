...
from model import mffenet,mffenetusetrans_c,FuseSeguseboundary,mffenetusecswintrans,fusesegusetrans_new,fusesegusetrans5,fusesegusetrans2,MFNet,RTFNet,afnet,FuseSeg,FuNNet,afnetusetrans,fusesegusetrans,fusesegusetrans3,fusesegusetrans4
from train_B import n_class, data_dir, model_dir
...
def main():
    ...
    test_dataset  = B_dataset(data_dir, 'test', have_label=True)
    ...
    with torch.no_grad():
        for it, (images, labels, names) in enumerate(test_loader):
            ...
            filepath = '/content/drive/MyDrive/MFNet-pytorch-master/weights/FuseSeg-B/FuseSeg/output/' + names[0] + '.png'
