...
from model import mffenet,mffenetusetrans_cross,mffenetusetrans_c,mffenetusecswintrans,fusesegusetrans_new,fusesegusetrans5,transformerlikefuse,MFNet, SegNet,RTFNet,afnet,SegNet,FuNNet,FuseSeg,afnetusetrans,fusesegusetrans,fusesegusetrans2,fusesegusetrans3,fusesegusetrans4
...
# data_dir='E:\google drive\edgenet\datasets/B(541)'
data_dir='/content/drive/MyDrive/edgenet2/datasets/B(541)/'
# data_dir  = '/content/drive/MyDrive/ir_seg_dataset2'
model_dir = '/content/drive/MyDrive/MFNet-pytorch-master/weights/FuseSeg-B/'
...
def main():
    ...
    train_dataset = B_dataset(data_dir, 'train', have_label=True, transform=augmentation_methods)
    val_dataset  = B_dataset(data_dir, 'test', have_label=True)
